...
namespace UnityEngine.UI
{
    ...
    public class Switch : Selectable, IPointerClickHandler, ISubmitHandler, ICanvasElement
    {
        ...
        private void ToggleState (float CompletionRatio)
        {
            ...
            selectedPanel.SetInsetAndSizeFromParentEdge(isOn ? RectTransform.Edge.Left : RectTransform.Edge.Right, selectedPanel.rect.width * (1 - CompletionRatio) + 3f, selectedPanel.rect.width);
            graphic.color = Color.Lerp(PanelColor[isOn ? 1 : 0], PanelColor[isOn ? 0 : 1], CompletionRatio);
